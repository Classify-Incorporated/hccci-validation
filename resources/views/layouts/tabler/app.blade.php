...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('asset/images/' . env('APP_LOGO', 'logo.png')) }}">
    <style>
...
<body class="{{ request()->query('theme', 'light') === 'dark' ? 'theme-dark' : 'theme-light' }}">
    <script>
        (function() {
            var savedTheme = localStorage.getItem('tablerTheme');
            var urlTheme = new URLSearchParams(window.location.search).get('theme');
            var theme = urlTheme || savedTheme || 'light';
            if (urlTheme) { localStorage.setItem('tablerTheme', urlTheme); }
